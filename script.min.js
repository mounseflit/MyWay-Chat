...
})()(
  {
        ...
        !(function () {
                ...
                if (null != e)
                  if (t && e.forEach === t) e.forEach(n, i);
                    ...
                    for (var r = 0, s = e.length; r < s; r++)
                      n.call(i, e[r], r, e);
                  else for (var o in e) this.has(e, o) && n.call(i, e[o], o, e);
              },
              once: function (t) {
                var e,
                  n = !1;
          ...
          r = {
            ...
            off: function (t, e, n) {
              ...
              for (
                f = 0, a = (l = t ? [t] : s.keys(this._events)).length;
                f < a;
                f++
              )
            ...
            stopListening: function (t, e, n) {
              ...
              if (!i) return this;
              var r = !e && !n;
              for (var s in ("object" == typeof e && (n = this),
              t && ((i = {})[t._listenerId] = t),
              i))
          ...
          var o = /\s+/,
            c = function (t, e, n, i) {
              ...
              if (o.test(n)) {
                for (var s = n.split(o), c = 0, l = s.length; c < l; c++)
                  t[e].apply(t, [s[c]].concat(i));
                return !1;
              }
              return !0;
            },
            ...
            r[e] = function (e, n, i) {
              return (
                ((this._listeners || (this._listeners = {}))[
                  e._listenerId || (e._listenerId = s.uniqueId("l"))
                ] = e),
        ...
        (function (global) {
          (function () {
            ...
            function c(t, r) {
              ...
              "object" == typeof h &&
                h &&
                ((r.stringify = h.stringify), (r.parse = h.parse));
              var p,
                g,
                y,
                b = a.prototype,
              ...
              function v(t) {
                ...
                if ("bug-string-char-index" == t) e = "a" != "a"[0];
                  ...
                  e = v("json-stringify") && v("json-parse");
                else {
                  var n,
                    ...
                    if (f) {
                      ...
                      try {
                        f =
                          ...
                          "[null]" == a([y]) &&
                          "null" == a(null) &&
                          "[null,null,null]" == a([y, j, null]) &&
                          a({ a: [n, !0, !1, null, "\0\b\n\f\r\t"] }) == c &&
                          "1" === a(null, n) &&
                          "[\n 1,\n 2\n]" == a([1, 2], null, 1) &&
                          '"-271821-04-20T00:00:00.000Z"' ==
                            a(new l(-864e13)) &&
                          '"+275760-09-13T00:00:00.000Z"' == a(new l(864e13)) &&
                          '"-000001-01-01T00:00:00.000Z"' ==
                            a(new l(-621987552e5)) &&
                          '"1969-12-31T23:59:59.999Z"' == a(new l(-1));
                      } catch (t) {
                        f = !1;
                      }
                    }
              ...
              if (!v("json")) {
                    ...
                    N = function (t, e, r, n, o, c, i) {
                      ...
                      if ("object" == typeof a && a)
                        if (
                          ...
                          if (A) {
                            for (
                              h = S(a / 864e5), f = S(h / 365.2425) + 1970 - 1;
                              A(f + 1, 0) <= h;
                              f++
                            );
                            for (
                ...
                if (!v("json-parse")) {
                  var U,
                    ...
                    F = function () {
                      for (var t, e, r, n, o, c = J, i = c.length; U < i; )
                        switch ((o = c.charCodeAt(U))) {
                          case 9:
                          case 10:
                          case 13:
                          case 32:
                          ...
                          default:
                            if (
                              ((e = U),
                              45 == o && ((n = !0), (o = c.charCodeAt(++U))),
                              o >= 48 && o <= 57)
                            ) {
                              for (
                                48 == o &&
                                  (o = c.charCodeAt(U + 1)) >= 48 &&
                                  o <= 57 &&
                                  M(),
                                  n = !1;
                                U < i && (o = c.charCodeAt(U)) >= 48 && o <= 57;
                                U++
                              );
                            ...
                            if ((n && M(), "true" == c.slice(U, U + 4)))
                              return (U += 4), !0;
                            if ("false" == c.slice(U, U + 5))
                              return (U += 5), !1;
                            if ("null" == c.slice(U, U + 4))
                              return (U += 4), null;
                            M();
                        }
                      return "$";
            ...
            if (
              (!o ||
                (o.global !== o && o.window !== o && o.self !== o) ||
                (n = o),
              r && !t)
            )
              c(n, r);
      ...
      function (require, module, exports) {
        ...
        function Promise(e) {
          ...
          (this.state = PENDING),
            (this.queue = []),
            (this.outcome = void 0),
            e !== INTERNAL && safelyResolveThenable(this, e);
        }
        ...
        function resolve(e) {
          return e instanceof this
            ? e
            : handlers.resolve(new this(INTERNAL), e);
        }
        function reject(e) {
        ...
        function all(e) {
          ...
          for (
            var o = new Array(r), i = 0, s = -1, u = new this(INTERNAL);
            ++s < r;
          ...
          function l(e, s) {
            t.resolve(e).then(
              function (e) {
                (o[s] = e),
                  ++i !== r || n || ((n = !0), handlers.resolve(u, o));
              },
              function (e) {
        ...
        function race(e) {
          ...
          var r = e.length,
            n = !1;
          if (!r) return this.resolve([]);
          for (var o, i = -1, s = new this(INTERNAL); ++i < r; )
            (o = e[i]),
              t.resolve(o).then(
                function (e) {
        ...
        (module.exports = Promise),
          ...
          (Promise.prototype.then = function (e, t) {
            if (
              ("function" != typeof e && this.state === FULFILLED) ||
              ("function" != typeof t && this.state === REJECTED)
            )
              return this;
            var r = new this.constructor(INTERNAL);
            this.state !== PENDING
              ? unwrap(r, this.state === FULFILLED ? e : t, this.outcome)
              : this.queue.push(new QueueItem(r, e, t));
            return r;
          }),
    ...
    7: [
      function (require, module, exports) {
        ...
        function arrayLikeKeys(r, e) {
          var t =
              isArray(r) || isArguments(r) ? baseTimes(r.length, String) : [],
            n = t.length,
            o = !!n;
          for (var a in r)
            (!e && !hasOwnProperty.call(r, a)) ||
              (o && ("length" == a || isIndex(a, n))) ||
              t.push(a);
          return t;
        }
        function assignValue(r, e, t) {
          var n = r[e];
          (hasOwnProperty.call(r, e) && eq(n, t) && (void 0 !== t || e in r)) ||
            (r[e] = t);
        }
        function baseKeys(r) {
          ...
          for (var t in Object(r))
            hasOwnProperty.call(r, t) && "constructor" != t && e.push(t);
          return e;
        }
        function baseRest(r, e) {
          return (
            (e = nativeMax(void 0 === e ? r.length - 1 : e, 0)),
            function () {
              for (
                var t = arguments,
                  n = -1,
                  o = nativeMax(t.length - e, 0),
                  a = Array(o);
                ++n < o;
        ...
        function createAssigner(r) {
          return baseRest(function (e, t) {
            var n = -1,
              ...
              i = o > 2 ? t[2] : void 0;
            for (
              a = r.length > 3 && "function" == typeof a ? (o--, a) : void 0,
                i &&
                  isIterateeCall(t[0], t[1], i) &&
                  ((a = o < 3 ? void 0 : a), (o = 1)),
                e = Object(e);
              ++n < o;
        ...
        function isIndex(r, e) {
          return (
            !!(e = null == e ? MAX_SAFE_INTEGER : e) &&
            ("number" == typeof r || reIsUint.test(r)) &&
            r > -1 &&
            r % 1 == 0 &&
            r < e
          );
        ...
        function isIterateeCall(r, e, t) {
          ...
          return (
            !!("number" == n
              ? isArrayLike(t) && isIndex(e, t.length)
              : "string" == n && e in t) && eq(t[e], r)
          );
        }
        ...
        function isArguments(r) {
          return (
            isArrayLikeObject(r) &&
            hasOwnProperty.call(r, "callee") &&
            (!propertyIsEnumerable.call(r, "callee") ||
              objectToString.call(r) == argsTag)
          );
        }
        ...
        var assign = createAssigner(function (r, e) {
          if (nonEnumShadows || isPrototype(e) || isArrayLike(e))
            copyObject(e, keys(e), r);
          else
            for (var t in e)
              hasOwnProperty.call(e, t) && assignValue(r, t, e[t]);
        });
        function keys(r) {
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          function hashSet(t, e) {
            return (
              (this.__data__[t] =
                nativeCreate && void 0 === e ? HASH_UNDEFINED : e),
              this
            );
          }
          ...
          function listCacheDelete(t) {
            ...
            return (
              !(r < 0) &&
              (r == e.length - 1 ? e.pop() : splice.call(e, r, 1), !0)
            );
          }
          ...
          function baseGet(t, e) {
            for (
              var r = 0, a = (e = isKey(e, t) ? [e] : castPath(e)).length;
              null != t && r < a;
          ...
          var stringToPath = memoize(function (t) {
            ...
            var e = [];
            return (
              reLeadingDot.test(t) && e.push(""),
              t.replace(rePropName, function (t, r, a, o) {
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          function arrayMap(e, t) {
            for (var r = -1, a = e ? e.length : 0, n = Array(a); ++r < a; )
              n[r] = t(e[r], r, e);
            return n;
          }
          ...
          function hashSet(e, t) {
            return (
              (this.__data__[e] =
                nativeCreate && void 0 === t ? HASH_UNDEFINED : t),
              this
            );
          }
          ...
          function listCacheDelete(e) {
            ...
            return (
              !(r < 0) &&
              (r == t.length - 1 ? t.pop() : splice.call(t, r, 1), !0)
            );
          }
          ...
          function arrayLikeKeys(e, t) {
            var r =
                isArray(e) || isArguments(e) ? baseTimes(e.length, String) : [],
              a = r.length,
              n = !!a;
            for (var o in e)
              (!t && !hasOwnProperty.call(e, o)) ||
                (n && ("length" == o || isIndex(o, a))) ||
                r.push(o);
            return r;
          }
          ...
          function baseDifference(e, t, r, a) {
            ...
            r && (t = arrayMap(t, baseUnary(r))),
              a
                ? ((o = arrayIncludesWith), (s = !1))
                : t.length >= LARGE_ARRAY_SIZE &&
                  ((o = cacheHas), (s = !1), (t = new SetCache(t)));
            e: for (; ++n < i; ) {
              var l = e[n],
                h = r ? r(l) : l;
          ...
          function baseKeysIn(e) {
            ...
            var t = isPrototype(e),
              r = [];
            for (var a in e)
              ("constructor" != a || (!t && hasOwnProperty.call(e, a))) &&
                r.push(a);
            return r;
          }
          ...
          function isPrototype(e) {
            ...
            return (
              e === (("function" == typeof t && t.prototype) || objectProto)
            );
          }
          ...
          function isArguments(e) {
            return (
              isArrayLikeObject(e) &&
              hasOwnProperty.call(e, "callee") &&
              (!propertyIsEnumerable.call(e, "callee") ||
                objectToString.call(e) == argsTag)
            );
          }
          var isArray = Array.isArray;
          ...
          var omit = baseRest(function (e, t) {
            return null == e
              ? {}
              : ((t = arrayMap(baseFlatten(t, 1), toKey)),
                basePick(e, baseDifference(getAllKeysIn(e), t)));
          });
          function stubArray() {
            return [];
          }
      ...
      function (require, module, exports) {
        ...
        inherits(EventEmitter, EventTarget),
          ...
          (EventEmitter.prototype.emit = function () {
            ...
            if (e) {
              for (
                var r = arguments.length, n = new Array(r - 1), i = 1;
                i < r;
                i++
              )
                n[i - 1] = arguments[i];
        ...
        (EventTarget.prototype.addEventListener = function (t, e) {
          ...
          (EventTarget.prototype.removeEventListener = function (t, e) {
            ...
            if (s) {
              ...
              -1 === i ||
                (s.length > 1
                  ? (this._listeners[t] = s.slice(0, i).concat(s.slice(i + 1)))
          ...
          (EventTarget.prototype.dispatchEvent = function () {
            ...
            if (
              (this["on" + e] && this["on" + e].apply(this, s),
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (module.exports = function (e, r) {
              ...
              r.forEach(function (e) {
                e.facadeTransport &&
                  (i[e.facadeTransport.transportName] = e.facadeTransport);
              }),
                (i[InfoIframeReceiver.transportName] = InfoIframeReceiver),
                (e.bootstrap_iframe = function () {
                  ...
                  eventUtils.attachEvent("message", function (t) {
                    if (
                      t.source === parent &&
                      (void 0 === a && (a = t.origin), t.origin === a)
                    ) {
                      var n;
                      try {
                      ...
                      if (n.windowId === iframeUtils.currentWindowId)
                        switch (n.type) {
                          case "s":
                            var o;
                            try {
                            ...
                            if (
                              !urlUtils.isOriginEqual(f, loc.href) ||
                              !urlUtils.isOriginEqual(u, loc.href)
                            )
                              throw new Error(
    ...
    22: [
      function (require, module, exports) {
        ...
        function InfoReceiverIframe(e) {
          var r = this;
          EventEmitter.call(this),
            (this.ir = new InfoAjax(e, XHRLocalObject)),
            this.ir.once("finish", function (e, i) {
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          function InfoIframe(e, r) {
            ...
            EventEmitter.call(this);
            var t = function () {
              var t = (i.ifr = new IframeTransport(
              ...
              t.once("message", function (e) {
                if (e) {
                  ...
                  try {
                    ...
                    return (
                      debug("bad json", e), i.emit("finish"), void i.close()
                    );
                  }
                  var t = r[0],
                    n = r[1];
      ...
      function (require, module, exports) {
        (function (process) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (InfoReceiver._getReceiver = function (e, i, r) {
              return r.sameOrigin
                ? new InfoAjax(i, XHRLocal)
                : XHRCors.enabled
                ? new InfoAjax(i, XHRCors)
                : XDR.enabled && r.sameScheme
                ? new InfoAjax(i, XDR)
                : InfoIframe.enabled()
                ? new InfoIframe(e, i)
                : new InfoAjax(i, XHRFake);
            }),
            (InfoReceiver.prototype.doXhr = function (e, i) {
              var r = this,
                t = urlUtils.addPath(e, "/info");
              debug("doXhr", t),
                (this.xo = InfoReceiver._getReceiver(e, t, i)),
                (this.timeoutRef = setTimeout(function () {
                  debug("timeout"), r._cleanup(!1), r.emit("finish");
                }, InfoReceiver.timeout)),
                this.xo.once("finish", function (e, i) {
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (SockJS.prototype.close = function (t, e) {
              if (t && !userSetCode(t))
            ...
            (SockJS.prototype.send = function (t) {
              ...
              this.readyState === SockJS.OPEN &&
                this._transport.send(escape.quote(t));
            }),
            ...
            (SockJS.CLOSING = 2),
            (SockJS.CLOSED = 3),
            (SockJS.prototype._receiveInfo = function (t, e) {
              if ((debug("_receiveInfo", e), (this._ir = null), t)) {
                (this._rto = this.countRTO(e)),
                  (this._transUrl = t.base_url ? t.base_url : this.url),
                  (t = objectUtils.extend(t, this._urlInfo)),
                  debug("info", t);
                var r = transports.filterToEnabled(
            ...
            (SockJS.prototype._connect = function () {
              for (
                ...
                if (
                  (debug("attempt", t.transportName),
                  t.needBody &&
                    (!global.document.body ||
                      (void 0 !== global.document.readyState &&
                  ...
                  case "a":
                    Array.isArray(e) &&
                      e.forEach(function (t) {
                        debug("message", r.transport, t),
                          r.dispatchEvent(new TransportMessageEvent(t));
                      });
                    break;
                  case "m":
                    debug("message", this.transport, e),
                      this.dispatchEvent(new TransportMessageEvent(e));
                    break;
                  case "c":
                    Array.isArray(e) &&
                      2 === e.length &&
            ...
            (SockJS.prototype._transportClose = function (t, e) {
              debug("_transportClose", this.transport, t, e),
                this._transport &&
            ...
            (SockJS.prototype._close = function (t, e, r) {
              ...
              var s = !1;
              if (
                (this._ir && ((s = !0), this._ir.close(), (this._ir = null)),
                this._transport &&
              ...
              (this.readyState = SockJS.CLOSING),
                setTimeout(
                  function () {
                    (this.readyState = SockJS.CLOSED),
                      s && this.dispatchEvent(new Event("error"));
            ...
            (module.exports = function (t) {
              return (
                ...
                require("./iframe-bootstrap")(SockJS, t),
                SockJS
              );
            });
        }).call(
    ...
    27: [
      function (require, module, exports) {
        ...
        var defineProperties = function (t, r, e) {
            for (var n in r)
              ObjectPrototype.hasOwnProperty.call(r, n) &&
                defineProperty(t, n, r[n], e);
          },
          toObject = function (t) {
            if (null == t)
        ...
        defineProperties(FunctionPrototype, {
          bind: function (t) {
            ...
            for (
              var e = array_slice.call(arguments, 1),
                n = Math.max(0, r.length - e.length),
                i = [],
                o = 0;
              o < n;
              o++
        ...
        defineProperties(
          ArrayPrototype,
          {
            indexOf: function (t) {
              ...
              var n = 0;
              for (
                arguments.length > 1 && (n = toInteger(arguments[1])),
        ...
        ".".split(/()()/).length > 1
          ? (function () {
              ...
              StringPrototype.split = function (r, e) {
                ...
                if ("[object RegExp]" !== _toString.call(r))
                  return string_split.call(this, r, e);
                var i,
                  o,
                  s,
                  p,
                  ...
                  a = 0;
                for (
                  r = new RegExp(r.source, l + "g"),
                    n += "",
                    t || (i = new RegExp("^" + r.source + "$(?!\\s)", l)),
                    e = void 0 === e ? -1 >>> 0 : ToUint32(e);
                  (o = r.exec(n)) &&
                  !(
                    (s = o.index + o[0].length) > a &&
                    (c.push(n.slice(a, o.index)),
                    !t &&
                      o.length > 1 &&
                    ...
                    o.length > 1 &&
                      o.index < n.length &&
                      ArrayPrototype.push.apply(c, o.slice(1)),
                    (p = o[0].length),
                    (a = s),
                    c.length >= e)
                  );
          ...
          : "0".split(void 0, 0).length &&
            (StringPrototype.split = function (t, r) {
              return void 0 === t && 0 === r
                ? []
                : string_split.call(this, t, r);
            });
        ...
        (function (process, global) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (AbstractXHRObject.prototype._start = function (t, e, i, r) {
              ...
              (e = urlUtils.addQuery(e, "t=" + +new Date())),
              ...
              if (
                ((r && r.noCredentials) ||
                  ...
                  (debug("withCredentials"), (this.xhr.withCredentials = !0)),
                r && r.headers)
              )
                for (var n in r.headers)
                  this.xhr.setRequestHeader(n, r.headers[n]);
                  ...
                  switch ((debug("readyState", i.readyState), i.readyState)) {
                    ...
                    case 4:
                      (e = i.status),
                        ...
                        1223 === e && (e = 204),
                        (12005 !== e && 12029 !== e) || (e = 0),
                        debug("finish", e, i.responseText),
                        s.emit("finish", e, i.responseText),
                        s._cleanup(!1);
                  }
                }
              };
    ...
    33: [
      function (require, module, exports) {
        ...
        inherits(HtmlFileTransport, AjaxBasedTransport),
          (HtmlFileTransport.enabled = function (e) {
      ...
      function (require, module, exports) {
        (function (process) {
          ...
          function IframeTransport(e, t, r) {
            ...
            EventEmitter.call(this);
            var s = this;
            (this.origin = urlUtils.getOrigin(r)),
              (this.baseUrl = r),
              (this.transUrl = t),
              (this.transport = e),
            ...
            debug(e, t, i),
              (this.iframeObj = iframeUtils.createIframe(i, function (e) {
                debug("err callback"),
                  s.emit("close", 1006, "Unable to load an iframe (" + e + ")"),
                  s.close();
              })),
            ...
            return function (r, n, t) {
              ...
              return (
                a.once("finish", function (e) {
                  if ((debug("finish", e), (a = null), 200 !== e && 204 !== e))
                    return t(new Error("http status " + e));
                  t();
                }),
                function () {
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          module.exports = function (r) {
            ...
            return (
              inherits(e, IframeTransport),
              (e.enabled = function (e, t) {
                if (!global.document) return !1;
                var n = objectUtils.extend({}, t);
                return (
                  (n.sameOrigin = !0), r.enabled(n) && IframeTransport.enabled()
                );
              }),
              (e.transportName = "iframe-" + r.transportName),
              (e.needBody = !0),
              (e.roundTrips = IframeTransport.roundTrips + r.roundTrips - 1),
              (e.facadeTransport = r),
              e
            );
          };
            ...
            (Polling.prototype._scheduleReceiver = function () {
              ...
              i.on("message", function (i) {
                ...
                i.once("close", function (t, l) {
                  debug("close", t, l, e.pollIsClosing),
                    (e.poll = i = null),
                    e.pollIsClosing ||
                      ("network" === l
                        ? e._scheduleReceiver()
                        : (e.emit("close", t || 1006, l),
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          function HtmlfileReceiver(e) {
            ...
            var t = HtmlfileReceiver.htmlfileEnabled
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (JsonpReceiver.prototype._callback = function (e) {
              debug("_callback", e),
                this._cleanup(),
                this.aborting ||
                  (e && (debug("message", e), this.emit("message", e)),
            ...
            (JsonpReceiver.prototype._createScript = function (e) {
              ...
              if (
                ...
                (i.onreadystatechange = function () {
                  if (
                    (debug("onreadystatechange", i.readyState),
                ...
                if (browser.isOpera())
                  ((t = this.script2 =
                    global.document.createElement("script")).text =
      ...
      function (require, module, exports) {
        (function (process) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (XhrReceiver.prototype._chunkHandler = function (e, i) {
    ...
    45: [
      function (require, module, exports) {
        (function (process, global) {
          ...
          function createForm() {
            debug("createForm"),
              ((form = global.document.createElement("form")).style.display =
                "none"),
              (form.style.position = "absolute"),
              (form.method = "POST"),
              (form.enctype = "application/x-www-form-urlencoded"),
              (form.acceptCharset = "UTF-8"),
              ((area = global.document.createElement("textarea")).name = "d"),
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (module.exports = function (e, r, o) {
              ...
              var n = function (e) {
                debug("completed", a, e),
                  t.onerror &&
                    ((t.onreadystatechange = t.onerror = t.onload = null),
                    setTimeout(function () {
                      debug("cleaning up", a),
              ...
              return (
                ...
                (t.onreadystatechange = function (e) {
                  debug("onreadystatechange", a, t.readyState, e),
      ...
      function (require, module, exports) {
        (function (process, global) {
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (XDRObject.prototype._start = function (e, t, r) {
              debug("_start");
              var i = this,
                n = new global.XDomainRequest();
              (t = urlUtils.addQuery(t, "t=" + +new Date())),
                (n.onerror = function () {
                ...
                (n.onprogress = function () {
                  debug("progress", n.responseText),
                    i.emit("chunk", 200, n.responseText);
                }),
                (n.onload = function () {
                  debug("load"),
                    i.emit("finish", 200, n.responseText),
                    i._cleanup(!1);
                }),
                (this.xdr = n),
          ...
          function WebSocketTransport(e, t, s) {
            ...
            (o =
              "https" === o.slice(0, 5)
                ...
                : "ws" + o.slice(4)),
              (this.url = o),
              (this.ws = new WebsocketDriver(this.url, [], s)),
    ...
    52: [
      function (require, module, exports) {
        ...
        inherits(XdrStreamingTransport, AjaxBasedTransport),
          (XdrStreamingTransport.enabled = function (r) {
            return (
              !r.cookie_needed &&
              !r.nullOrigin &&
              XDRObject.enabled &&
    ...
    53: [
      function (require, module, exports) {
        ...
        inherits(XhrPollingTransport, AjaxBasedTransport),
          (XhrPollingTransport.enabled = function (r) {
            return (
              !r.nullOrigin &&
              (!(!XHRLocalObject.enabled || !r.sameOrigin) ||
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          inherits(XhrStreamingTransport, AjaxBasedTransport),
            (XhrStreamingTransport.enabled = function (r) {
              return (
                !r.nullOrigin && !browser.isOpera() && XHRCorsObject.enabled
              );
            }),
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          global.crypto && global.crypto.getRandomValues
            ...
            : (module.exports.randomBytes = function (r) {
                for (var o = new Array(r), t = 0; t < r; t++)
                  o[t] = Math.floor(256 * Math.random());
                return o;
              });
        }).call(
          this,
      ...
      function (require, module, exports) {
        ...
        var extraLookup,
          ...
          unrollLookup = function (u) {
            ...
            return (
              (u.lastIndex = 0),
              e.join("").replace(u, function (u) {
                return (
                  (a[u] =
                    "\\u" + ("0000" + u.charCodeAt(0).toString(16)).slice(-4)),
                  ""
                );
              }),
              (u.lastIndex = 0),
        ...
        module.exports = {
          quote: function (u) {
            ...
            return (
              ...
              extraEscapable.test(f)
                ? (extraLookup || (extraLookup = unrollLookup(extraEscapable)),
                  f.replace(extraEscapable, function (u) {
        ...
        (function (global) {
          ...
          module.exports = {
            attachEvent: function (a, o) {
              void 0 !== global.addEventListener
                ? global.addEventListener(a, o, !1)
                : global.document &&
                  global.attachEvent &&
                  (global.document.attachEvent("on" + a, o),
                  global.attachEvent("on" + a, o));
            },
            detachEvent: function (a, o) {
              void 0 !== global.addEventListener
                ? global.removeEventListener(a, o, !1)
                : global.document &&
                  global.detachEvent &&
                  (global.document.detachEvent("on" + a, o),
                  global.detachEvent("on" + a, o));
            },
          ...
          "production" !== process.env.NODE_ENV &&
            ...
            (module.exports = {
              ...
              createIframe: function (e, o) {
                var t,
                  n,
                  r = global.document.createElement("iframe"),
                  l = function () {
                ...
                return (
                  ...
                  global.document.body.appendChild(r),
                  (t = setTimeout(function () {
                    u("timeout");
                  }, 15e3)),
                  (n = eventUtils.unloadAdd(i)),
                  {
                    post: function (e, o) {
                      debug("post", e, o),
                        setTimeout(function () {
              ...
              createHtmlfile: function (e, o) {
                ...
                i.open(),
                  ...
                  i.close(),
                  (i.parentWindow[module.exports.WPrefix] =
                    global[module.exports.WPrefix]);
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          ["log", "debug", "warn"].forEach(function (o) {
            ...
            try {
              l =
                global.console && global.console[o] && global.console[o].apply;
            } catch (o) {}
            logObject[o] = l
              ? function () {
    ...
    62: [
      function (require, module, exports) {
        ...
        module.exports = {
          string: function (r) {
            for (
              var n = _randomStringChars.length,
                t = crypto.randomBytes(r),
                o = [],
                e = 0;
              e < r;
              e++
            )
              o.push(_randomStringChars.substr(t[e] % n, 1));
            return o.join("");
          },
          number: function (r) {
                      ...
                      e &&
                        ("websocket" !== e.transportName || !1 !== r.websocket
                          ? t.length && -1 === t.indexOf(e.transportName)
                            ? debug("not in whitelist", e.transportName)
                            : e.enabled(r)
                            ? (debug("enabled", e.transportName),
                              a.main.push(e),
                              e.facadeTransport &&
                                a.facade.push(e.facadeTransport))
                            : debug("disabled", e.transportName)
            ...
            function i() {
              if (i.enabled) {
                ...
                (n[0] = n[0].replace(/%([a-zA-Z%])/g, function (e, t) {
                  ...
                  r.formatArgs.call(s, n),
                  (s.log || r.log).apply(s, n);
              }
            }
            return (
              (i.namespace = e),
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          function resolve(e, o) {
            for (
              var t = (o || "/").split("/").slice(0, -1).concat(e.split("/")),
                r = t.length,
                s = t[r - 1],
                a = !1,
                n = 0;
          ...
          function Url(e, o, t) {
            ...
            var r,
              ...
              u = 0;
            for (
              "object" !== h && "string" !== h && ((t = o), (o = null)),
                t && "function" != typeof t && (t = qs.parse),
                o = lolcation(o),
                r = !(s = extractProtocol(e || "")).protocol && !s.slashes,
                p.slashes = s.slashes || (r && o.slashes),
                p.protocol = s.protocol || o.protocol || "",
                e = s.rest,
                s.slashes || (c[3] = [/(.*)/, "pathname"]);
              u < c.length;
              u++
            )
              "function" != typeof (n = c[u])
                ? ((a = n[0]),
                  (i = n[1]),
                  a != a
                    ? (p[i] = e)
                    ...
                    ? ~(l = e.indexOf(a)) &&
                      ("number" == typeof n[2]
                        ? ((p[i] = e.slice(0, l)), (e = e.slice(l + n[2])))
                        : ((p[i] = e.slice(l)), (e = e.slice(0, l))))
                    : (l = a.exec(e)) &&
                      ((p[i] = l[1]), (e = e.slice(0, l.index))),
                  (p[i] = p[i] || (r && n[3] && o[i]) || ""),
                  n[4] && (p[i] = p[i].toLowerCase()))
                : (e = n(e));
            t && (p.query = t(p.query)),
              r &&
                o.slashes &&
                "/" !== p.pathname.charAt(0) &&
                ("" !== p.pathname || "" !== o.pathname) &&
                (p.pathname = resolve(p.pathname, o.pathname)),
              required(p.port, p.protocol) ||
          ...
          function set(e, o, t) {
            ...
            switch (e) {
              case "query":
                "string" == typeof o && o.length && (o = (t || qs.parse)(o)),
                  (r[e] = o);
                break;
              case "port":
                (r[e] = o),
                  required(o, r.protocol)
                    ? o && (r.host = r.hostname + ":" + o)
          ...
          function toString(e) {
            ...
            return (
              t.username &&
                ((s += t.username),
                t.password && (s += ":" + t.password),
                (s += "@")),
              (s += t.host + t.pathname),
              (o = "object" == typeof t.query ? e(t.query) : t.query) &&
                (s += "?" !== o.charAt(0) ? "?" + o : o),
              t.hash && (s += t.hash),
              s
            );
    ...
    70: [
      function (require, module, exports) {
        module.exports = {
          ...
          websocketOptions: { origin: "http://websocket.org" },
    ...
    71: [
      function (require, module, exports) {
        ...
        config.SockJS && (config.SockJS = require("sockjs-client")),
          config.WS && (config.WS = require("ws"));
        var Promise = require("lie"),
          ...
          warn = _require.warn,
          States = { CLOSED: 0, OPEN: 1, HANDSHAKEN: 2, AUTHENTICATED: 3 },
        ...
        function Scaledrone(e, t) {
          ...
          (t = assign(
            ...
            (this.args = arguments),
            (this.args[1] = t),
            (this.originalInstance = t.originalInstance),
            (this.readyState = States.CLOSED),
            (this.callbackId = 0),
            (this.callbacks = {}),
            (this.rooms = {}),
            (this.disconnected = !1),
            (this.connection = getConnection(t)),
            (this.emitter = Events.mixin({})),
            sockEvents(this.connection, this.emitter, { debug: t.debug }),
            ...
            this.emitter.on("open", function () {
              (r.readyState = States.OPEN),
                r._sendMessage(
                  "handshake",
                  { channel: e, version: 2, client_data: t.data },
                  {},
                  function (e, t) {
                    e ||
                      ((r.clientId = t.client_id),
                      (r.readyState = States.HANDSHAKEN),
                      (r.requireAuth = t.require_auth)),
                      r._trigger("open", e);
                  }
                );
            }),
              ...
              if (
                ...
                if (null != t.callback) {
                  var i = t.callback,
                    o = r.callbacks[i];
                  if (isFunction(o))
                    return o(wrapError(t.error), n), void delete r.callbacks[i];
                }
                if (t.error) r.trigger("error", wrapError(t.error));
                  ...
                  if ("publish" === t.type) {
                    ...
                    return (
                      s._observable &&
                        a &&
                        ((u = s._getCacheMember(a)), (c.member = u)),
                      s.trigger("message", c),
                      void s.trigger("data", t.message, u)
                    );
                  }
            ...
            this.emitter.on("close", function (e) {
              r.autoReconnect &&
              get(e, "code") === ABNORMAL_CLOSURE &&
              -1 === get(e, "reason", "").indexOf("exceeded")
                ? (r.disconnected || r.trigger("disconnect"),
                  reconnect(r, t, e))
                : r.trigger("close", e);
            }),
        ...
        function reconnect(e, t, r) {
          ...
          if (reconnectAttempt > 25) n.trigger("close", r);
            ...
            var i = 1e3 * reconnectAttempt++ * (Math.random() + 0.5);
            setTimeout(function () {
              var t = n.args,
                r = new Scaledrone(t[0], t[1]);
              r.innerEmitter.on("open", function () {
                for (var t in ((reconnectAttempt = 0),
                (r.emitter = n.emitter),
                (e.connection.old = !0),
                (n.connection = r.connection),
                sockEvents(r.connection, n.emitter),
                n.rooms))
                  r.subscribe(t);
                n.trigger("reconnect");
              });
        ...
        function getConnection(e) {
          return "sockjs" !== e.type && supportsWebsockets()
            ? isNode
              ? new config.WS(
                  e.url || config.websocketUrl,
                  config.websocketOptions
                )
              : new WebSocket(e.url || config.websocketUrl)
            : new config.SockJS(e.url || config.sockjsUrl, null, {
                transports: [
                  "xdr",
                  "websocket-streaming",
                  "xhr-streaming",
        ...
        Events.mixin(Scaledrone.prototype),
          (Scaledrone.prototype._trigger = function (e, t) {
            hasListeners(this, e)
              ? this.trigger(e, t)
              : t && this.trigger("error", t),
              this.innerEmitter.trigger(e, t);
          }),
          ...
          (Scaledrone.prototype.subscribe = function (e) {
            ...
            return (
              ...
              this._sendMessage(
                "subscribe",
                { room: e, history: t, history_count: t },
          ...
          (Scaledrone.prototype.publish = function (e) {
            ...
            this.requireAuth &&
              ...
              (warn("Messages can be sent after authenticating"), (t = {})),
              this._sendMessage(
                "publish",
          ...
          (Scaledrone.prototype.authenticate = function (e) {
            ...
            this._sendMessage(
              ...
              function (r) {
                (t.readyState = States.AUTHENTICATED),
                  (t.token = e),
                  t.emitter.trigger("authenticate", r);
              }
            );
          }),
              ...
              fullyConnected: new Promise(function (t, r) {
                e.innerEmitter.once("open", function (n) {
                  n
                    ? r(n)
                    : e.requireAuth
                    ? e.innerEmitter.once("authenticate", function (e) {
                        e ? r(e) : t();
                      })
                    : t();
                });
          ...
          isBrowser
            ? ((window.ScaleDrone = window.Scaledrone = Scaledrone),
              module && (module.exports = Scaledrone))
      ...
      function (require, module, exports) {
        ...
        function Room(e, s, t) {
          var i = this,
            r = s.historyCount;
          (this.name = e),
            (this._history = { messages: [], nextIndex: 0 }),
            (this._historyCount = r),
            (this.scaledrone = t),
            (this._observable = isObservable(e)),
            this._observable &&
              ((this._cache = []),
              this.on("members", function (e) {
        ...
        Events.mixin(Room.prototype),
          ...
          (Room.prototype._trigger = function (e, s) {
            hasListeners(this, e)
              ? this.trigger(e, s)
              : s && this.scaledrone.trigger("error", s);
          }),
          (Room.prototype._handleHistoryMessage = function (e) {
            var s = this;
            (this._history.messages[e.index] = e),
              this._history.messages[this._history.nextIndex] &&
                (function e() {
                  var t = s._history.messages[s._history.nextIndex];
                  s._history.nextIndex++;
                  var i = t.message,
                    r = t.client_id,
                    n = { data: i, timestamp: t.timestamp, id: t.id };
                  r && (n.clientId = r),
                    s.trigger("history_message", n),
                    s._history.messages[s._history.nextIndex] && e();
                })();
          }),
          (module.exports = Room);
      },
    ...
    73: [
      function (require, module, exports) {
        ...
        module.exports = function (o, e) {
          ...
          (o.onopen = function (r) {
            o.old ||
              (n && console.log("[SCALEDRONE DEBUGGER]: open", r),
              e.trigger("open", r));
          }),
            (o.onmessage = function (r) {
              o.old ||
                (n && console.log("[SCALEDRONE DEBUGGER]: message", r),
                e.trigger("message", r));
            }),
            (o.onclose = function (r) {
              o.old ||
                (n && console.log("[SCALEDRONE DEBUGGER]: close", r),
                e.trigger("close", r));
            }),
            (o.onerror = function (r) {
              o.old ||
                (n && console.log("[SCALEDRONE DEBUGGER]: error", r),
                e.trigger("error", r));
            });
        };
      },
